...
import com.miot.android.data.d.utils.CommonUtil;
import com.miot.android.data.d.utils.Util;
...
public class MultiCard {
	...
	public final static int TYPE_DIA = 11;
...
//	private final String FORMAT_FR
	...
	private int getFileType(String fileName) {
		...
		else if (fileName.endsWith(FORMAT_DIA)) {
			return TYPE_DIA;
		}
		else {
			return TYPE_DATA;
